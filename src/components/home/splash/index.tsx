  ...
  return (
    <section className={styles.homeSplash}>
      <div className={styles.homeImage}>
        <img fetchPriority="high" src="/images/DSC00373.jpg" />
      </div>
      <div className={styles.homeOverlay} ref={overlayRef}></div>
      <div className={styles.homeQuote} ref={quoteRef}>
        <div className={styles.homeQuoteText}>Photography is just capturing a moment<br/>and keeping it both in the past and in the future.<br/>I like finding moments worth keeping.</div>
      </div>
